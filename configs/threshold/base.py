...
custom_hooks = [
    ...
    dict(type="ThresAdjust",adjust_step=60000,rpn_decay_factor=0,rcnn_decay_factor=0.1,rcnn_end_step=150000,rpn_end_step=0 ),
]
...
work_dir = "work_dirs/used_pretrained/dynamic_thres/hold_rpn_0.9/0.1/60000/without_reg/${percent}/${fold}"
