...
weak_pipeline_1 = [
    ...
    dict(type="Pad", size_divisor=32),
    dict(type="Normalize", **img_norm_cfg),
    dict(type="ExtraAttrs", tag="unsup_teacher_1"),
    dict(type="DefaultFormatBundle"),
    dict(
        type="Collect",
        keys=["img", "gt_bboxes", "gt_labels"],
...
weak_pipeline_2 = [
    ...
    dict(type="Pad", size_divisor=32),
    dict(type="Normalize", **img_norm_cfg),
    dict(type="ExtraAttrs", tag="unsup_teacher_2"),
    dict(type="DefaultFormatBundle"),
    dict(
        type="Collect",
        keys=["img", "gt_bboxes", "gt_labels"],
...
weak_pipeline_3 = [
    ...
    dict(type="Pad", size_divisor=32),
    dict(type="Normalize", **img_norm_cfg),
    dict(type="ExtraAttrs", tag="unsup_teacher_3"),
    dict(type="DefaultFormatBundle"),
    dict(
        type="Collect",
        keys=["img", "gt_bboxes", "gt_labels"],
...
unsup_pipeline = [
    ...
    dict(
        type="MultiBranch", unsup_student=strong_pipeline, unsup_teacher1=weak_pipeline_1,
        unsup_teacher2 = weak_pipeline_2,unusp_teacher3 = weak_pipeline_3,
    ),
]
