...
from ssod.models.utils.utils import sort_index
from .multi_stream_detector import MultiSteamDetector
from .utils import Transform2D, filter_invalid

@DETECTORS.register_module()
class MultiTestTeacher(MultiSteamDetector):
    def __init__(self, model: dict, train_cfg=None, test_cfg=None):
        super(MultiTestTeacher, self).__init__(
    ...
    def foward_unsup_train(self, teacher_data1,teacher_data2,teacher_data3, student_data):
        ...
        # sort teacher index
        tidx = sort_index(t1names,t2names,t3names,snames)

        data_list = [teacher_data1,teacher_data2,teacher_data3]
        with torch.no_grad():
            data_info_dict = {}
            for i,teacher_data in enumerate(data_list):
                # teacher_data  = teacher_data{i}
                ...
                key_name = 'teacher_info_'+str(i)
                data_info_dict[key_name] = teacher_info
            # 融合bbox和proposal信息
            # merge_data(data_info_dict)
